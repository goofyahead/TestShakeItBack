...
io.sockets.on('connection', function (socket) {
    ...
    socket.on('joinRoom', function (data){ //data = { roomId: '1', apiKey : '1', userName: '' }
        ...
        socket.broadcast.to(socket.apiKey + ":" + socket.roomId).emit('joined', { user : socket.playerName });
    ...
    socket.on('disconnect', function () {
        ...
        socket.volatile.broadcast.to(socket.apiKey + ":" + socket.roomId).emit('disconnected', { user : socket.playerName });
    });
